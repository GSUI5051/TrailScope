/* TrailScope module: analysis.js — generated by JS modularization build. */
        ...
        function analyzeSegments(data, mode) {
            ...
            if (mode === 'waypoint') {
                ...
                for (let i = 0; i < uniqueBreakpoints.length - 1; i++) {
                    ...
                    if (endIdx > startIdx) {
                        ...
                        if (i === 0) {
                            ...
                            seg.name = wps[i - 1] ? wps[i - 1].name : `Segment ${i}`;
                            seg.endName = wps[i] ? wps[i].name : `Segment ${i+1}`;
                        }
                        segments.push(seg);
                    }
                }
                ...
                // Remainder segment: covers the remaining distance less than one full segment
