...
document.addEventListener('DOMContentLoaded', () => {
    ...
    bind('segFixedDist', 'click', () => {
        const size = UnitHelper.getSystem() === 'imperial' ? 1609.34 : 1000;
        setSegmentSize(size);
    });
    ...
    bind('metricUnitBtn', 'click', () => setUnitSystem('metric'));
    bind('imperialUnitBtn', 'click', () => setUnitSystem('imperial'));
