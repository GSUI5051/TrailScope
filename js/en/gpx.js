...
function parseGPX(gpxText) {
    ...
    if (pointElements.length > GPX_MAX_TRACK_POINTS) throw new Error('GPX contains too many track points');
    ...
    if (waypointElements.length > GPX_MAX_WAYPOINTS) throw new Error('GPX contains too many waypoints');
    const waypoints = [];
