/* TrailScope module: ui.js — generated by JS modularization build. */
        function updatePaginationControls() {
            ...
            document.getElementById('pageSizeInfo').innerHTML = ` segment in a page, ${totalSegments} total`;
        ...
        function updateSegments() {
            ...
            document.getElementById('segmentTotalCount').textContent = `${totalSegments} segments, `;
            ...
            fetch('./demo-en.gpx')
                ...
                .then(gpxText => {
                    try {
                        ...
                        showToast('Load demo trails successful!', 'success');
